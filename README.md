...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 548 :fork_and_knife: 174 - A module for parsing m3u8 file.
...
* Productivity Tools
    ...
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 4057 :fork_and_knife: 263 - Select files out of bash output.
...
* NoSQL Databases
    ...
    * [:octocat: HappyBase](https://github.com/wbolster/happybase) - :star: 448 :fork_and_knife: 137 - A developer-friendly library for Apache HBase.
...
* Profiler
    ...
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 21 :fork_and_knife: 5 - Monitor Memory usage of Python code.
...
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 849 :fork_and_knife: 166 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.
...
* Archive
    * [:octocat: unp](https://github.com/mitsuhiko/unp) - :star: 340 :fork_and_knife: 62 - A command line tool that can unpack archives easily.
...
* GUI / Web Testing
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 2521 :fork_and_knife: 364 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
...
* General
    ...
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 417 :fork_and_knife: 45 - An implementation of figlet written in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 3296 :fork_and_knife: 715 - HTML Content/Article Extractor.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 3150 :fork_and_knife: 258 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 6808 :fork_and_knife: 1061 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 12851 :fork_and_knife: 3161 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 3266 :fork_and_knife: 283 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 6886 :fork_and_knife: 1051
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 457 :fork_and_knife: 51
...
* [:octocat: AutobahnPython](https://github.com/crossbario/autobahn-python) - :star: 1972 :fork_and_knife: 559 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 1622 :fork_and_knife: 226 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 1173 :fork_and_knife: 234 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 1028 :fork_and_knife: 256 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 104126 :fork_and_knife: 13671
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 5655 :fork_and_knife: 497
* Python
    * [:octocat: pycrumbs](https://github.com/kirang89/pycrumbs) - :star: 2819 :fork_and_knife: 688
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 540 :fork_and_knife: 149
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 2129 :fork_and_knife: 537
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 694 :fork_and_knife: 153
